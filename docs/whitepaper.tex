...
\item Prepend the version byte 0x49 or "W" to the RIPEMD-160 hash.
...
The topic-based publish/subscribe communication system is organized around a set of topics. I define each \textbf{topic} as 160 bit key.
